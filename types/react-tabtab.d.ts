...
export class AsyncPanel extends React.PureComponent {
...
export class DragTab extends React.PureComponent {
...
export class DragTabList extends React.PureComponent {
  constructor(...args: any[]);
...
export class ExtraButton extends React.PureComponent {
  constructor(...args: any[]);
...
export class PanelList extends React.PureComponent {
  constructor(...args: any[]);
...
export namespace Tabs {
  namespace defaultProps {
    ...
    const showModalButton: boolean | number;

    function onTabChange(index: number): void;

    function onTabEdit(): void;
